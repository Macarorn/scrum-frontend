          ...
          <div>
            <nav aria-label="breadcrumb" className="mb-2">
              <ol className="breadcrumb mb-0" style={{ fontSize: '0.875rem' }}>
                ...
                <li className="breadcrumb-item"><Link to={`/detalles_de_proyecto/${form.id_proyecto || idProyecto}`} className="text-decoration-none text-muted">Proyecto</Link></li>
                <li className="breadcrumb-item"><Link to={`/sprints?id_proyecto=${form.id_proyecto || idProyecto}`} className="text-decoration-none text-muted">Sprints</Link></li>
                <li className="breadcrumb-item active" aria-current="page">Detalle</li>
              </ol>
            </nav>
            <h1 className="sprint-title mb-0">
